        ...
        <React.Fragment>
            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="mt-4 text-base font-normal leading-7 text-gray-200 lg:text-lg lg:mt-6 lg:leading-8">
                ...
                <div className="flex items-center justify-center mt-8 space-x-6 sm:mt-12">
                    <div className="flex items-center">
                        <input
                            ...
                            id="monthly"
                            name="pricing-plans"
                            className="w-4 h-4 text-primary border border-gray-200 focus:ring-1 focus:outline-none focus:ring-blue-600"
                            defaultChecked
                        />
                        <label
                            htmlFor="monthly"
                            className="block ml-3 text-sm font-medium text-white sm:text-base"
                        >
                            {" "}
                            Monthly Plan{" "}
                        </label>
                ...
                <div className="grid max-w-5xl grid-cols-1 mx-auto mt-12 lg:grid-cols-3 lg:gap-8 sm:mt-16 lg:mt-20">
                    <div className="bg-white border border-gray-200 divide-y divide-gray-200 rounded-2xl sm:rounded-3xl">
                        ...
                        <div className="px-4 py-5 sm:p-6">
                            <div className="flex items-end">
                                ...
                                <p className="py-1 text-sm font-normal text-gray-500">/mo/user</p>
                            </div>
                            <div className="mt-6">
                                <a
                                    href="#"
                    ...
                    <div className="relative bg-white border border-gray-200 divide-y divide-gray-200 rounded-2xl sm:rounded-3xl mt-14 lg:mt-0">
                        ...
                        <div className="px-4 py-5 sm:p-6">
                            <div className="flex items-end">
                                <p className="text-5xl font-semibold text-white">$49</p>
                                <p className="py-1 text-sm font-normal text-gray-500">/mo/user</p>
                            </div>
                            <div className="mt-6">
                                <a
                                    href="#"
                                    title=""
                                    className="inline-flex items-center justify-center w-full px-6 py-3 text-base font-medium text-white transition-all duration-200 bg-primary border border-transparent rounded-xl hover:bg-primary/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary/hover:bg-primary/50"
                                    role="button"
                                >
                                    Get 14 days free trial
                                </a>
                    ...
                    <div className="mt-6 bg-white border border-gray-200 divide-y divide-gray-200 rounded-2xl sm:rounded-3xl lg:mt-0">
                        ...
                        <div className="px-4 py-5 sm:p-6">
                            <div className="flex items-end">
                                <p className="text-5xl font-semibold text-white">$99</p>
                                <p className="py-1 text-sm font-normal text-gray-500">/mo/user</p>
                            </div>
                            <div className="mt-6">
                                <a
