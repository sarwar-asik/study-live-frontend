...
export default function Footer() {
    return (
        <React.Fragment><footer className="bg-gray-900 font-sans tracking-wide">
                ...
                <div>
                    ...
                    <form>
                        <div className="flex">
                            <input
                                type="email"
                                className="px-4 py-4 text-sm rounded-l-md w-full focus:outline-none bg-gray-50"
                                placeholder="Enter your email address"
                            />
                            <button
                                type="button"
                                className="bg-gray-600 hover:bg-gray-500 text-white px-4 rounded-r-md text-sm tracking-wide transition-all"
                            >
                                Subscribe
                            </button>
                        </div>
